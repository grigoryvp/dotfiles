...
addRemap(["3", "appname", "Path of Exile"], ["m2"], ["send", "`"{!}(non-curse|all maximum|cannot regenerate|less recovery|reduced flask|taunted|reflect|goatmen)|((40|60|80|100)% deli)|memories`""])
