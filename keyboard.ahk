...
addRemap("5", ["m2"], ["send", "`"{!}(p tie|rea l|lity:|ent sh|ted sh|r's sh|abyss|incub|scara|each ri)`" `"mirror|vine o|anci|exal|annu|deck|pris|aos o|regr|chis|foss|reson|cata|sco|aal or|glas|son o|ack o|ent o|ver o|den o|ted o|ive o|tic oi|envy|drea|scor|zeal|spit|netol|chayu`""])
