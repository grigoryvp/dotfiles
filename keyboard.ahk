...
;;  m2-2 for game text
addRemap("2", ["m2"], ["send", "`"{!}(gen|elo|s rec|o al|non)|((40|60|80|100)% deli)`""])

;;  m2-s-2 for game text
;; FIXME: not working with 'shift'
addRemap("6", ["m2"], ["send", "`"{!}(gen|elo|s rec|o al|non|ask)|((40|60|80|100)% deli)`""])
...
;;  m2-4 for game text
addRemap("4", ["m2"], ["send", "`"{!}(ap ti|client:|(nt|ed|r's) sh|incu|scar|ch ri|em so)`" `"(on|ck|ent|ver|en) oi|chis|r's p|chay|ror sh|(ine|ent|ted|aos|aal|tic|gal) or|of (kal|ann|fu|ch|alc|ho|regr|alt)|deck|foss|reson|cata|sco|glas|envy|drea|scor|zeal|spit|ghas`""])

;;  m2-s-4 for game text
;; FIXME: not working with 'shift'
addRemap("5", ["m2"], ["send", "`"{!}(ap ti|client:|(nt|ed|r's) sh|incu|scar|ch ri|em so)`" `"(on|ck|ent|ver|en) oi|chis|r's p|chay|ror sh|(ine|aos) o|of (kal|conta|awa|pre|cat|inv|bloodl|cal|corn)|(se|ring|al|ied|low|hic|eted|red) fo|(ring|ile|tic) ca|en su`""])
