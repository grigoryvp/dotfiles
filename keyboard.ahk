...
;;  m2-6 for game text
addRemap("6", ["m2"], ["send", "`"{!}(ap ti|client:|(nt|ed|r's) sh|incu|scar|ch ri|em so)`" `"(on|ck|ent|ver|en) oi|chis|r's (p|b)|chay|ror sh|(ine|aos) o|of (kal|conta|awa|pre|cat|inv|bloodl|cal|corn|reg)|(se|ring|al|ied|low|hic|eted|red) fo|(ile|tic) ca|en su|deck`""])

;;  m2-7 for game text
addRemap("7", ["m2"], ["send", "-\w-.-|r-g-b|r-b-g|b-r-g|b-g-r|g-r-b|g-b-r|rint"])

;;  m2-8 for game text
addRemap("7", ["m2"], ["send", "`"Bone R|Vermil|Amet|Vise|Heavy|Leather B|Crystal B|Convoking|Bone S|Ivory|Fossil|Leviathan|Velour|Warlock|Wyvernscale|Paladin|Phantom|Giantslayer|Majestic|Lich'|Haunted|Divine|Torturer'|Royal|Syndicate'|Twilight|Conquest|Sacred|Necrotic`""])
