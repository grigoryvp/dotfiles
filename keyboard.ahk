...
addRemap(["2", "appname", "Path of Exile"], ["m2"], ["send", "`"{!}(non-curse|all maximum|cannot regenerate|less recovery|damage as|monster damage|monster elemental)|((80|100)% deli)|memories`""])
...
addRemap(["3", "appname", "Path of Exile"], ["m2"], ["send", "`"{!}(non-curse|all maximum|cannot regenerate|less recovery|damage as|monster damage|monster elemental|reduced flask|taunted|goatmen|extra physical|projectiles)|((40|60|80|100)% deli)|memories`""])
...
;;  m2-9 for game text
addRemap("9", ["m2"], ["send", "`"at least|cannot drop|poss|fract|bottle|divine|arca|oper|star|pantheon|belt|lantern|4000 w|strongbo|rare monsters in all voy|sulphur found in all`""])
