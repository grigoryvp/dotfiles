...
addRemap("4", ["m2"], ["send", "`"{!}(ap ti|ea le|ity:|nt sh|ed sh|r's sh|abys|incu|scar|ch ri)`" `"mirr|ine o|ent o|ted o|of an|deck|pris|aos o|regr|chis|foss|reson|cata|sco|al or|glas|on oi|ck oi|nt oi|er oi|en oi|envy|drea|scor|zeal|spit|neto|chay|tic o|of fu|of ch|of al`""])
