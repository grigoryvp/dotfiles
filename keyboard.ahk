...
;;  m2-4 for game text
addRemap("4", ["m2"], ["send", "`"{!}(ap ti|(nt|ed|r's) sh|incu|scar|ch ri|em so)`" `"mirr|(ine|ent|ted|aos|aal|tic|gal) or|of (ann|fu|ch|alc|ho|regr)|(on|ck|ent|ver|en) oi|deck|r's p|chis|foss|reson|cata|sco|glas|envy|drea|scor|zeal|spit|chay|ghas`""])
