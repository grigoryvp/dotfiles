...
;; FIXME: not working with 'shift'
addRemap("5", ["m2"], ["send", "`"{!}(ap ti|ea le|lity:|nt sh|ed sh|r's sh|abys|incu|scar|ch ri)`" `"mirr|ine o|deck|r's p|aos o|chis|se fo|ng fo|al fo|ied fo|ring ca|le ca|ic ca|on oi|ck oi|ent oi|ver oi|en oi|chay|en su|of con|of awa|of pre|of cat|of inv|of blo|of cal|of cor`""])
