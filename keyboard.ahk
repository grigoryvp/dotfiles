...
;;  m2-9 for game text
addRemap("9", ["m2"], ["send", "`"strongboxes|lanterns|message|pantheon|giant|wisps|inhabitants|possessed|cannot|fracture on|sulphur found in all|60% increased number of (magic|rare)|monsters in all`""])
