...
;;  m2-9 for game text
addRemap("9", ["m2"], ["send", "`"strongboxes|lanterns|message|pantheon|starfish|wisps|at least|inhabitants|possessed|cannot drop|fracture on|sulphur found in all|60% increased number of (magic|rare)|monsters in all`""])
