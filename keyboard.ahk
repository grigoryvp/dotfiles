...
addRemap("5", ["m2"], ["send", "`"{!}(p tier|require)`" `"vine|anci|exal|annu|deck|pris|chaos|regr|chis|fos|cata|sco|al or|glas|crim|black o|opal|silv|gold|taint|refle|prism|envy|dread|scorn|zeal|spite|netol|chayu`""])
