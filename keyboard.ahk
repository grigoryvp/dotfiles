...
;;  m2-2 for game text
addRemap(["2", "appname", "Path of Exile 2"], ["m2"], ["send", "`"{!}(resistances|weakness|ailment application|break armour|less recovery|chilled ground)`""])
...
addRemap(["3", "appname", "Path of Exile 2"], ["m2"], ["send", "`"{!}(resistances|weakness|ailment application|break armour|less recovery|chilled ground)`""])
