...
addRemap("5", ["m2"], ["send", "`"{!}(p tier|require|ient sha)`" `"vine|anci|exal|annu|deck|pris|chaos|regr|chis|fos|cata|sco|aal or|glas|crim|black o|opal|silv|gold|taint|refle|prism|envy|dread|scorn|zeal|spite|netol|chayu`""])
