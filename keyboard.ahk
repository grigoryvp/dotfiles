...
addRemap("5", ["m2"], ["send", "`"{!}(p tier|require|ient sha|ent sha|ted sha|cloist)`" `"vine o|anci|exal|annu|deck|pris|chaos|regr|chis|fos|cata|sco|aal or|glas|crim|lack o|cent o|lver o|lden o|nted o|tive o|atic oi|envy|dread|scorn|zeal|spite|netol|chayu`""])
