...
;;  m2-4 for game text
addRemap("4", ["m2"], ["send", "`"{!}(ap ti|ea le|vel:|nt sh|ed sh|r's sh|incu|scar|ch ri)`" `"mirr|ine o|ent o|ted o|of ann|deck|r's p|aos o|regr|chis|foss|reson|cata|sco|aal or|glas|on oi|ck oi|ent oi|ver oi|en oi|envy|drea|scor|zeal|spit|chay|tic o|of fu|of ch|of alc|of ho`""])
