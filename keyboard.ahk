...
addRemap("5", ["m2"], ["send", "`"{!}(p tie|a lev)`" `"vine|anci|exal|annu|card|pris|chaos|regr|chis|fos|cata|sco|vaal o|glas|crim|black o|opal|silv|gold|taint|refle|prism|envy|dread|scorn|zeal|spite|netol|chayu`""])
