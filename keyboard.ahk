...
addRemap("4", ["m2"], ["send", "`"{!}(ap ti|ea le|ity:|nt sh|ed sh|r's sh|abys|incu|scar|ch ri)`" `"mirr|ine o|ent o|ted o|of an|deck|pris|aos o|regr|chis|foss|reson|cata|sco|al or|glas|son o|ack o|ent o|ver o|den o|ted o|ive o|tic oi|envy|drea|scor|zeal|spit|neto|chay|tic o|of fu|of ch`""])
