...
;;  m2-2 for game text 2
addRemap("2", ["m2"], ["send", "-\w-.-|r-g-b|r-b-g|b-r-g|b-g-r|g-r-b|g-b-r|rint"])

;;  m2-3 for game text 3
addRemap("3", ["m2"], ["send", "`"vy b|r be|a a|on j|ege a|spine|nt ro|eted b|vir|int'|ved g|sage'|amp`""])

;;  m2-4 for game text 4
addRemap("4", ["m2"], ["send", "`"scythe artifact|coin|the sun|medved|vorana|uhtred|olroth`""])

;;  m2-5 for game text 5
addRemap("5", ["m2"], ["send", "`"{!}rges|eec|gen|elo|s rec|o al|non`""])

;;  m2-6 for game text 6
addRemap("6", ["m2"], ["send", "`"{!}d en|eec|gen|elo|o al|non`""])
