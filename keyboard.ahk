...
;; FIXME: not working with 'shift'
addRemap("5", ["m2"], ["send", "`"{!}(ap ti|client:|(nt|ed|r's) sh|incu|scar|ch ri|em so)`" `"(on|ck|ent|ver|en) oi|chis|r's p|chay|ror sh|(ine|aos) o|of (kal|conta|awa|pre|cat|inv|bloodl|cal|corn)|(se|ng|al|ied) fo|(ring|ile|tic) ca|en su`""])
