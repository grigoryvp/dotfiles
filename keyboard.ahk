...
addRemap("1", ["m2", "shift"], ["send", "-\w-.-|r-g-b|r-b-g|b-r-g|b-g-r|g-r-b|g-b-r|rint"])

;;  m2-2 for game text
addRemap("2", ["m2"], ["send", "`"{!}d en|eec|gen|elo|o al|non`""])

;;  m2-s-2 for game text
addRemap("2", ["m2", "shift"], ["send", "`"{!}rges|eec|gen|elo|s rec|o al|non`""])

;;  m2-3 for game text
addRemap("3", ["m2"], ["send", "`"scythe artifact|coin|the sun|medved|vorana|uhtred|olroth`""])

;;  m2-s-3 for game text
addRemap("3", ["m2", "shift"], ["send", "`"Bone R|Vermil|Amet|Vise|Heavy|Leather B|Crystal B|Convoking|Bone S|Ivory|Fossil|Leviathan|Velour|Warlock|Wyvernscale|Paladin|Phantom|Giantslayer|Majestic|Lich'|Haunted|Divine|Torturer'|Royal|Syndicate'|Twilight|Conquest|Sacred|Necrotic`""])

;;  m2-4 for game text
addRemap("4", ["m2"], ["send", "`"{!}(ap ti|ea le|lity:|nt sh|ed sh|r's sh|abys|incu|scar|ch ri)`" `"mirr|ine o|ent o|ted o|of ann|deck|pris|aos o|regr|chis|foss|reson|cata|sco|aal or|glas|on oi|ck oi|ent oi|ver oi|en oi|envy|drea|scor|zeal|spit|chay|tic o|of fu|of ch|of alc|of ho`""])

;;  m2-s-4 for game text
addRemap("4", ["m2", "shift"], ["send", "`"{!}(ap ti|ea le|lity:|nt sh|ed sh|r's sh|abys|incu|scar|ch ri)`" `"mirr|ine o|deck|pris|aos o|chis|se fo|ng fo|al fo|ed fo|ting ca|le ca|ic ca|on oi|ck oi|ent oi|ver oi|en oi|chay|en su|of con|of awa|of pre|of cat|of inv|of blo|of cal|of cor`""])
