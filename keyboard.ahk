...
;; FIXME: not working with 'shift'
addRemap("5", ["m2"], ["send", "`"{!}(ap ti|ea le|level:|nt sh|ed sh|r's sh|abys|incu|ch ri)`" `"r of k|ror sh|ine o|r's p|aos o|chis|se fo|ng fo|al fo|ied fo|ring ca|ile ca|tic ca|on oi|ck oi|ent oi|ver oi|en oi|chay|en su|of conta|of awa|of pre|of cat|of inv|of bloodl|of cal|of corn`""])
